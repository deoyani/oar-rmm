...
/**
 * SearchController class serves all the search requests.
 * @author dsn1
 *
 */
public class SearchController {
	 ...
	 * @return Catalog as per POD schema
	 * @throws IOException
	 */
